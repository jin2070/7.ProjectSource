...
@property(nonatomic,weak)TouchActionScrollView *itemScrollView;
...
- (void)initialize {
   ...
   // UIScrollView *itemScrollView = [[UIScrollView alloc] init];
    TouchActionScrollView *itemScrollView = [[TouchActionScrollView alloc] init];
    itemScrollView.contentSize=CGSizeMake(0, 0);
    itemScrollView.showsVerticalScrollIndicator = NO;
    itemScrollView.showsHorizontalScrollIndicator = NO;
    itemScrollView.backgroundColor=[UIColor grayColor];
    // itemScrollView.delegate=backgroundView;
    //---  [backgroundView addSubview:itemScrollView];
    _itemScrollView = itemScrollView;
    self.itemScrollView.delegate=self;
    [self.backgroundView addSubview:self.itemScrollView];
...
- (void)layoutSubviews {
   ...
   // self.backgroundView.frame = CGRectMake(20, 50, 300, 100);
  ...
  //  self.itemScrollView.frame=CGRectMake(0, 30, 350, 50);
